# The Delay Weaver — content renders after delayed response
...
describe('The Delay Weaver', () => {
  it('content renders after delayed response', () => {
      cy.intercept('GET', '/api/items', { delay: 300, body: { items: ['rune-stone'] } }).as('req');
