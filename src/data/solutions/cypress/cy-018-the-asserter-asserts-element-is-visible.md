# The Asserter — asserts element is visible
...
describe('The Asserter', () => {
  it('asserts element is visible', () => {
      cy.visit('/pages/level-04/');
      cy.get('#hero-badge').should('be.visible');
...
describe('The Asserter', () => {
  it('asserts element is visible', () => {
    cy.visit('/pages/level-04/');
    // Hint: select "#hero-badge" and assert it is visible
