# The Quest Portal — reward section appears after claim-reward click
...
describe('Quest Portal — Full Journey', () => {
  it('reward section appears after claim-reward click', () => {
      cy.visit('/pages/level-74/');
      cy.get('#adventurer-name').type('Zorn');
...
describe('Quest Portal — Full Journey', () => {
  it('reward section appears after claim-reward click', () => {
    cy.visit('/pages/level-74/');
    // Hint: type "Zorn" into "#adventurer-name"
