# The Delay Weaver — loading state appears during delay
...
describe('The Delay Weaver', () => {
  it('loading state appears during delay', () => {
      cy.intercept('GET', '/api/items', { delay: 1500, body: { items: ['item'] } }).as('delayed');
