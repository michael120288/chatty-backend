# The Type Oracle — instanceof checks prototype chain
...
describe('The Type Oracle', () => {
  it('instanceof checks prototype chain', () => {
      cy.wrap([]).should('be.instanceof', Array);
      cy.wrap({}).should('be.instanceof', Object);
    });
});
```
