...
class UserRoutes {
  ...
  public routes(): Router {
    ...
    this.router.get('/user/profile/:userId', authMiddleware.checkAuthentication, validateObjectId('userId'), Get.prototype.profileByUserId);
    this.router.get('/user/profile/posts/:username/:userId/:uId', authMiddleware.checkAuthentication, validateObjectId('userId', 'uId'), Get.prototype.profileAndPosts);
    ...
    this.router.patch('/user/profile/basic-info', authMiddleware.checkAuthentication, Edit.prototype.info);
    this.router.put('/user/profile/social-links', authMiddleware.checkAuthentication, Edit.prototype.social);
    this.router.patch('/user/profile/social-links', authMiddleware.checkAuthentication, Edit.prototype.social);
